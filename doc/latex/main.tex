...
\titulo{Relatório de Iniciação Científica: Vitrine um Sistema de Publicação de Conteúdo Científico}
\autor{Caio Augusto Silva dos Reis}
\local{São João Del Rei, Minas Gerais}
\data{\the\year}
\orientador{Prof. Dr. Matheus Carvalho Viana}
...
\preambulo{Relatório Final de Iniciação Científica apresentado ao Departamento de Ciência da Computação da Universidade Federal de São João Del Rei, referente às atividades de pesquisa desenvolvidas de setembro de 2025 a fevereiro de 2026. O trabalho descreve a concepção e implementação do sistema Vitrine, sob orientação do Prof. Dr. Matheus Carvalho Viana.}
\logo{imgs/university-logo.png} % [A FAZER: Adicione o logo da sua universidade na pasta 'imgs']
